...
b2 = Button(root, text="Green",font=("times new roman",15,"bold"),bg="green",fg="white",activebackground="blue",activeforeground="red",cursor="hand2", command=green).place(x=10,y=70,width=150,height=28)
